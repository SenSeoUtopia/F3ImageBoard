...
var bar = $('.progress-bar.progress-bar-success.progress-bar-striped.active');
var percent = $('.progress-bar.progress-bar-success.progress-bar-striped.active');
...
// Update Reply Counter
$("#menu div.thread-stats .reply").html(b.total_reply);
// Update Images Counter
$("#menu div.thread-stats .images").html(b.total_images);
...
if(!is_logged_in){	
$("#message").charCounter(max_char_limit,{container: "#counter"});
} else {
$("#message").charCounter(max_char_limit,{container: "#counter"});	
}
});
